...
let teacherQueryVo = { name: "王" };
// 执行接口函数
listPage(1, 2, teacherQueryVo).then((result) => {
...
getById("1189390295668469762").then(resq => {
    var _a;
    console.log((_a = resq === null || resq === void 0 ? void 0 : resq.intro) !== null && _a !== void 0 ? _a : '数据为空');
});
...
// 执行更新接口
update(teacher).then((result) => {
    console.log(result);
});
remove('1404010314584784898').then((result) => {
    console.log(result);
});
/**
 * 日期解析
